...
// CRUD - Create (POST) Read (GET all) Update (GET one + PATCH) Delete (DELETE)
// добавляем html
// добавляем логику

// добавляем поиск
// добавляем html
// добавляем логику (_q=value) в get запрос для всех элементов из дб.жсон
// навесить событие на изменение значения в инпуте

// добавляем пагинацию
// добавляем див для пагинации (пустой)
// добавляем логику (_page&_limit) в get запрос для всех элементов из дб.жсон
// добавляем отображение кнопок prev, next, спан для текущей страницы
// навесить события на кнопки для перехода по страницам

// не забываем про проверку на заполненность инпутов при добавлении и при редактировании
